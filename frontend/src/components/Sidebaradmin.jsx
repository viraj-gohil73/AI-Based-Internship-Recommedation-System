      ...
      >
        ...
        <div className="border-t border-slate-300">
          ...
          <div className="p-2 pt-3 pb-0 flex items-center gap-3 ">
            <div className="w-11 h-11 ml-3 rounded-full border border-slate-400 bg-white-600 text-white flex items-center justify-center font-semibold text-sm overflow-hidden ">
